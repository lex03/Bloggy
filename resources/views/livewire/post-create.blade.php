            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="container mx-auto px-4">
                        <h1 class="text-center text-4xl mt-6 tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">Create Post</h1>
                        <p class="text-lg mt-2 text-center text-gray-600">Start crafting your new post below.</p>
                        <div class="space-y-8 mt-10">
                            @if($saveSuccessPublish)
                                <div class="rounded-md bg-green-100 rounded-lg p-4">
                                    ...
                                    <a class="mx-8 border-2 border-green-500 hover:border-green-800 px-1" href="/myblogs">View Blog</a>
                                </div>
                            @endif
                            @if($saveSuccessDraft)
                                <div class="rounded-md bg-green-100 rounded-lg p-4">
                                    ...
                                    <a class="mx-8 border-2 border-green-500 hover:border-green-800 px-1" href="/createdraft">View Drafts</a>
                                </div>
                            @endif
